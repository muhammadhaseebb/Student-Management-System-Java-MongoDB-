...
JFrame f;
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        try {
            ...
            MongoDatabase mydb=mongoclient.getDatabase("db_project");
            MongoCollection mycol=mydb.getCollection("department");  
            Document department=new Document("_id",dpt_code_tf.getText()).append("name",name_tf.getText());
            mycol.insertOne(department);
