...
public class viewCourse extends javax.swing.JFrame {
    ...
    private void add_btn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn5ActionPerformed
        ...
        try{
            ...
            List<org.bson.Document> course = department.getList("courses", org.bson.Document.class);
            
            for(int i = 0; i < course.size(); i++){
                
                
                String id = course.get(i).getString("_id");
                System.out.print(id);
                int creditHrs = course.get(i).getInteger("creditHrs");
                String name = course.get(i).getString("name");
                String category = course.get(i).getString("Category");
