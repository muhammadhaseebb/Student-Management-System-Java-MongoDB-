...
public class updateInstructor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cnic_tf.setText("Enter CNIC of the Instructor");
        ...
        jLabel12.setText("UPDATE INSTRUCTOR");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(77, 77, 77))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(add_btn2, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(90, 90, 90))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(phone_notf, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                                .addComponent(jLabel8)
                                .addComponent(jLabel6)
                                .addComponent(name_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                                .addComponent(jLabel7)
                                .addComponent(email_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                                .addComponent(cnic_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(add_btn2, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cnic_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        String instructor_id = (String) jComboBox2.getSelectedItem();
        ...
        try{
            ...
            Bson updates = Updates.combine(
                        Updates.set("instructor.$.name",name_tf.getText()),
                        Updates.set("instructor.$.email",email_tf.getText()),
                        Updates.set("instructor.$._id",instructor_id),
                        Updates.set("instructor.$.phone",phone_notf.getText()),
                        Updates.set("instructor.$.CNIC",cnic_tf.getText()),
                        Updates.set("instructor.$.password",password_tf.getText()));
                        
           
                UpdateOptions options = new UpdateOptions().upsert(true);
                collection.updateOne(new org.bson.Document().append("name",dpt_code).append("instructor._id",instructor_id),updates,options);

            
            
            JOptionPane.showMessageDialog(f, "Instructor Updated","Success", JOptionPane.PLAIN_MESSAGE);
    ...
    private void add_btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn2ActionPerformed
        ...
        try{
            ...
            List<Document> instructor_id = department.getList("instructor", Document.class);

            for(int i = 0; i < instructor_id.size(); i++){
                String inst_id = instructor_id.get(i).getString("_id");
