...
public class updateDepartment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("UPDATE DEPARTMENT");
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        ...
        try{
            ...
            Bson updates = Updates.combine(
                        Updates.set("name",name_tf.getText()));
                       
                UpdateOptions options = new UpdateOptions().upsert(true);
                collection.updateOne(new org.bson.Document().append("_id",dpt_code),updates,options);
            
            
            JOptionPane.showMessageDialog(f, "Department Updated","Success", JOptionPane.PLAIN_MESSAGE);
...
//                catNo ++;
                ...
                jComboBox1.addItem(category_id);
            }}
