                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(reg_no_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        try {
            MongoClient mongo = new MongoClient( "localhost" , 27017 );
                            ...
                            List <Document> student  = Arrays.asList(new Document().append("_id",reg_no_tf.getText()).append("password",password_tf.getText()).append("name",name_tf.getText()).append("email",email_tf.getText()).append("phone",phone_notf.getText()));

                                Bson updates = Updates.combine(
                                        Updates.pushEach("Student",student));
                                        UpdateOptions options = new UpdateOptions().upsert(true);
                                dept.updateOne(new Document().append("name",dpt_code), updates, options);
                                
                                JOptionPane.showMessageDialog(f, "Student Added","Success", JOptionPane.PLAIN_MESSAGE);
        }
        catch(Exception e)
        {
