...
public class addSection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        enrolled_students_tf = new javax.swing.JTextField();
        ...
        enrolled_students_tf.setText("Enter Number of Enrolled Students");
        enrolled_students_tf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                enrolled_students_tfActionPerformed(evt);
            }
        });
        ...
        id_tf1.setText("Enter Section ID");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(enrolled_students_tf)
                            .addComponent(id_tf1)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(id_tf1, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(enrolled_students_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        String course_code = (String) jComboBox3.getSelectedItem();
        int enrolled_students = Integer.parseInt(enrolled_students_tf.getText());
        try {
            MongoClient mongo = new MongoClient( "localhost" , 27017 );
                            ...
                            List <Document> Section  = Arrays.asList(new Document().append("Instructorid",instructor_id).append("code",course_code).append("_id",id_tf1.getText()).append("name",name_tf.getText()).append("enrolledStudents",enrolled_students));

                                Bson updates = Updates.combine(
                                        Updates.pushEach("Section",Section));
                                        UpdateOptions options = new UpdateOptions().upsert(true);
                                dept.updateOne(new Document().append("name",dpt_code), updates, options);
                                
                                JOptionPane.showMessageDialog(f, "Section Added","Success", JOptionPane.PLAIN_MESSAGE);
        }
        catch(Exception e)
        {
    ...
    private void enrolled_students_tfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enrolled_students_tfActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_enrolled_students_tfActionPerformed
...
//    }
    ...
    private javax.swing.JTextField enrolled_students_tf;
