...
public class deleteSection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("DELETE SECTION");
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        try {
            MongoClient mongo = new MongoClient( "localhost" , 27017 );
                ...
                Document update = new Document("$pull", new Document("Section", new Document("_id", id)));
    ...
    private void add_btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn2ActionPerformed
        ...
        try{
           MongoClient mongo = new MongoClient( "localhost" , 27017 );
            ...
            List<Document> sec = department.getList("Section", Document.class);
