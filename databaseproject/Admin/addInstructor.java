                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(department_tf, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE))))
                .addGap(59, 59, 59))
        );
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        try {
            MongoClient mongo = new MongoClient( "localhost" , 27017 );
                            ...
                            List <Document> instructor  = Arrays.asList(new Document().append("_id",reg_no_tf.getText()).append("email",email_tf.getText()).append("name",name_tf.getText()).append("password",password_tf.getText()).append("phone",phone_notf.getText()).append("CNIC",department_tf.getText()));

                                Bson updates = Updates.combine(
                                        Updates.pushEach("instructor",instructor));
