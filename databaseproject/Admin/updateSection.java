...
public class updateSection extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(add_btn2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(enrolled_student_tf)
                                    ...
                                    .addComponent(jComboBox4, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(jComboBox2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(95, 95, 95))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(add_btn2, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        ...
        String sec_id = (String) jComboBox2.getSelectedItem();
        String course_id = (String) jComboBox3.getSelectedItem();
        String ins_id = (String) jComboBox4.getSelectedItem();
        ...
        try{
            ...
            Bson updates = Updates.combine(
                        Updates.set("Section.$.Instructorid",ins_id),
                        Updates.set("Section.$.code",course_id),
                        Updates.set("Section.$._id",sec_id),
                        Updates.set("Section.$.name",name_tf.getText()),
                        Updates.set("Section.$.enrolledStudents",enrolled_student_tf.getText()));
                        
           
                UpdateOptions options = new UpdateOptions().upsert(true);
                collection.updateOne(new org.bson.Document().append("name",dpt_code).append("Section._id",sec_id),updates,options);
    ...
    private void add_btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn2ActionPerformed
        ...
        try{
            ...
            List<Document> course_id = department.getList("courses", Document.class);
            List<Document> section_id = department.getList("Section", Document.class);

            for(int i = 0; i < course_id.size(); i++){
                String cou_id = course_id.get(i).getString("_id");
                jComboBox3.addItem(cou_id);
            }
            for(int i = 0; i < instructor_id.size(); i++){
                String inst_id = instructor_id.get(i).getString("_id");
                jComboBox4.addItem(inst_id);
            }
            for(int i = 0; i < section_id.size(); i++){
                String sec_id = section_id.get(i).getString("_id");
