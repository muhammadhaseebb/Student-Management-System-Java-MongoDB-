...
public class AddMarks extends javax.swing.JFrame {
    ...
    public AddMarks(String sec, String id, String dpt) {
        initComponents();
        this.section=sec;
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        String reg_no = (String) jComboBox1.getSelectedItem();
        String deliverable_id = (String) jComboBox2.getSelectedItem();

        int omarks = Integer.parseInt(absent_tf.getText());
        try {
            MongoClient mongo = new MongoClient( "localhost" , 27017 );
                            ...
                            List <Document> marks  = Arrays.asList(new Document().append("SecID",section).append("regNo",reg_no).append("deliverable_id",deliverable_id).append("obtainedMarks",omarks));

                                Bson updates = Updates.combine(
                                        Updates.pushEach("obtainedMarks",marks));
