...
public class ViewMarks extends javax.swing.JFrame {
    ...
    public ViewMarks(String sec, String id, String dpt) {
        initComponents();
        this.section=sec;
...
InstructorMainMenu back = new InstructorMainMenu(section, instructor_id, dpt);  
    ...
    private void udateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_udateBtnActionPerformed
        // TODO add your handling code here:
        String d_id =(String) jComboBox1.getSelectedItem();
        try{
           MongoClient mongo = new MongoClient( "localhost" , 27017 );
            ...
            AggregateIterable <Document> output = collection.aggregate(Arrays.asList(
                    new Document("$unwind", "$obtainedMarks"),
                    new Document("$match", new Document("obtainedMarks.deliverable_id",d_id)),
                    new Document("$project",new Document("package_id","$obtainedMarks.deliverable_id")
                            .append("regno","$obtainedMarks.regNo")
                            .append("marks","$obtainedMarks.obtainedMarks")),
...
//            System.out.println(section.);
            ...
            while(itt.hasNext()){
                ...
                model.setValueAt(ed.getString("regno"), p, 0);
                model.setValueAt(ed.getInteger("marks"), p, 1);
                p++;
                //total++;
            }
