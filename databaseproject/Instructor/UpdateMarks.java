...
public class UpdateMarks extends javax.swing.JFrame {
    ...
    public UpdateMarks(String sec, String id, String dpt) {
        initComponents();
        this.section=sec;
    ...
    private void initComponents() {
        ...
        updateBtn1.setBackground(new java.awt.Color(64, 65, 106));
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        String d_id =(String) jComboBox2.getSelectedItem();
        int marks = Integer.parseInt(absent_tf.getText());
     ...
     try{
            ...
            Bson updates = Updates.combine(
                        Updates.set("obtainedMarks.$.obtainedMarks",marks));
                       
                       
                UpdateOptions options = new UpdateOptions().upsert(true);
                mycol.updateOne(new org.bson.Document().append("name",dpt).append("obtainedMarks.regNo",regno).append("obtainedMarks.deliverable_id",d_id),updates,options);

            
            
            JOptionPane.showMessageDialog(f, "Marks updated","Success", JOptionPane.PLAIN_MESSAGE);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        // TODO add your handling code here:
        DeleteMarks delete = new DeleteMarks(section, instructor_id, dpt);
    ...
    private void updateBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtn1ActionPerformed
        // TODO add your handling code here:
        UpdateMarks update = new UpdateMarks(section, instructor_id, dpt);
    ...
    private void view(){
        try{
            ...
            for(int i = 0; i < registers.size(); i++){
                String regno = registers.get(i).getString("regNo");
                String sec = registers.get(i).getString("id");
                if(sec.equals(section)){
                    jComboBox1.addItem(regno);}
            }
            for(int i = 0; i < deliverable.size(); i++){
                String d_id = deliverable.get(i).getString("_id");
                String sec = deliverable.get(i).getString("SecID");
                if(sec.equals(section))
                jComboBox2.addItem(d_id);
            }
        }
