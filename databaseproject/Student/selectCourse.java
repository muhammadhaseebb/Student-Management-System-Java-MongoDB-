...
public class selectCourse extends javax.swing.JFrame {
    ...
    public selectCourse(String id, String dpt) {
        initComponents();
        student_id = id;
        this.dpt = dpt;
        view();
    ...
    try{
           MongoClient mongo = new MongoClient( "localhost" , 27017 );
            ...
            List<Document> course = department.getList("Registers", Document.class);
            
            for(int i = 0; i < course.size(); i++){
                String courseName = course.get(i).getString("id");
                String reg_no = course.get(i).getString("regNo");
                if(reg_no.equals(student_id)){
